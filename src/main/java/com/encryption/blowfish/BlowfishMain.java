    ...
    public static void main(String[] args) {
        try {
            ...
            for (int size : testSizes) {
                ...
                BlowfishEncryption.EncryptionResult result = BlowfishEncryption.encrypt(key, plaintext);
                ...
                result = BlowfishEncryption.encrypt(key, plaintext);
                ...
                String decrypted = BlowfishEncryption.decrypt(key, result.getEncryptedBase64());
                ...
                decrypted = BlowfishEncryption.decrypt(key, result.getEncryptedBase64());
